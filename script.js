...
// =========================================================================
// БЛОК 1: ИНИЦИАЛИЗАЦИЯ И СЕТЕВАЯ НАСТРОЙКА ДЛЯ ОБХОДА БЛОКИРОВОК (БЕЗ QUIC)
// =========================================================================
const SUPABASE_URL = "https://lrjszannmammzzqotaro.supabase.co"; // Строго ваш URL проекта!
const SUPABASE_ANON_KEY = "sb_publishable_bwLDUQMS1RVwHF2wHE62hg_sODGX5vi";

// Вынуждаем Supabase работать через TCP (HTTP/1.1 / HTTP/2), минуя блокируемый провайдерами UDP HTTP/3
const supabaseClient = supabase.createClient(SUPABASE_URL, SUPABASE_ANON_KEY, {
    ...
    global: {
        // Подключаем стандартный браузерный fetch, который работает стабильно в РФ
...
// Стабильный метод отрисовки лонгридов на локальном глоссарии
