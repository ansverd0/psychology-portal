...
// =========================================================================
// ВРЕМЕННЫЙ СЛУЖЕБНЫЙ БЛОК: Автоматический перенос новостей и глоссария в облако
// =========================================================================
async function runCloudMigration() {
    console.log("🚀 Проверка необходимости миграции глоссария и новостей...");

    try {
        // 1. Проверяем, пуста ли таблица новостей
        const { data: existingNews } = await supabaseClient.from('news').select('id').limit(1);
        
        if (!existingNews || existingNews.length === 0) {
            console.log("📰 Облачный ченджлог пуст. Начинаем заливку новостей слово в слово...");
            
            const newsToUpload = [
                {
                    date: "04.09.2026",
                    title: "Раздел «Возрастная психология» доступен к изучению!",
                    changes: [
                        "Добавлен новый раздел «Возрастная психология» в блоке «Разделы психологии»",
                        "В раздел «Возрастная психология» добавлено 30 статей",
                        "В блок «Тренажер терминов» добавлено 60 новых карточек по разделу «Возрастная психология»",
                        "В блок «Интерактивные тесты» добавлено 80 новых вопросов по разделу «Возрастная психология»",
                        "В блок «Литература» добавлено 5 новых книг",
                        "В блок «Экзаменационные билеты» добавлено 54 новых вопроса с конспектами по разделу «Возрастная психология»",
                        "Исправлены опечатки"
                    ]
                },
                {
                    date: "04.09.2026",
                    title: "Раздел «Социальная психология» доступен к изучению!",
                    changes: [
                        "Добавлен новый раздел «Социальная психология» в блоке «Разделы психологии»",
                        "В раздел «Социальная психология» добавлено 15 статей",
                        "В block «Тренажер терминов» добавлено 52 новые карточки по разделу «Социальная психология»",
                        "В блок «Интерактивные тесты» добавлено 30 новых вопросов по разделу «Социальная психология»",
                        "В блок «Литература» добавлено 5 новых книг",
                        "В блок «Экзаменационные билеты» добавлено 16 новых вопросов с конспектами по разделу «Социальная психология»",
                        "Теперь вы можете выбрать количество вопросов для теста в блоке «Интерактивные тесты»",
                        "Теперь ответы на вопросы в тестах в блоке «Интерактивные тесты» будут отображаться в случайном порядке",
                        "Теперь при нажатии кнопки «Повторить конспект» в случае неправильного ответа, вы перейдёте сразу в блок «Разделы психологии» с раскрытым списком статей по теме вопроса",
                        "Мелкие изменения интерфейса"
                    ]
                },
                {
                    date: "02.09.2026",
                    title: "Раздел «Общая психология» доступен к изучению!",
                    changes: [
                        "Добавлены новые разделы в блоке «Разделы психологии»",
                        "В раздел «Общая психология» добавлено 22 статьи",
                        "В блок «Тренажер терминов» добавлено 65 новых карточек по разделу «Общая психология»",
                        "В блок «Интерактивные тесты» добавлено 30 новых вопросов по разделу «Общая психология»",
                        "В блок «Литература» добавлено 5 новых книг",
                        "В блок «Экзаменационные билеты» добавлено 32 новых вопроса с конспектами по разделу «Общая психология»",
                        "Кнопка «повторить конспект» при не правильном ответе в тесте теперь ведёт в раздел с информацией по этой теме",
                        "Исправлены опечатки и мелкие баги"
                    ]
                },
                {
                    date: "02.09.2026",
                    title: "Доработка технических возможностей",
                    changes: [
                        "Изменена навигация в блоке «Экзаменационные билеты»",
                        "Теееперь вопросы в блоке «Интерактивные тесты» генерируются в случайном порядке",
                        "Добавлена кнопка «повторить конспект» при неправильном ответе в тесте, которая ведёт на блок «Экзаменационные билеты»",
                        "Обновлён интерфейс тестов",
                        "Изменены основы блоков «Экзаменационные билеты» и «Разделы психологии», чтобы они не были похожими",
                        "Обновлён интерфейс блока «Экзаменационные билеты»",
                        "Добавлена возможность выбора темы для карточек в блоке «Тренажер терминов»",
                        "Добавлена возможность выбора темы для тестов в блоке «Интерактивные тесты»"
                    ]
                },
                {
                    date: "01.09.2026",
                    title: "Концепт сайта переходит от подготовки к ГОСу в направлении общего образовательного портала для студентов-психологов",
                    changes: [
                        "В каждый блок добавлена краткая инструкция",
                        "Добавлен раздел «Общая психология» в блок «Разделы психологии»",
                        "Теперь карточки в блоке «Тренажер терминов» генерируются в случайном порядке",
                        "Изменено описание для блока «Тренажер терминов» на главной странице",
                        "Изменено описание для блока «Разделы психологии» на главной странице",
                        "Изменена навигация в блоке «Разделы психологии»",
                        "Исправлены мелкие баги"
                    ]
                },
                {
                    date: "01.09.2026",
                    title: "Запуск первой стабильной версии сайта!",
                    changes: [
                        "Блок «Экзаменационные билеты»: в нём будут публиковаться вопросы к ГОС экзамену и коспекты по темам.",
                        "Блок «Тренажёр терминов»: здесь можно будет эффективнее запоминать сложные термины в формате игры.",
                        "Блок «Интерактивные тесты»: тут будут быстрые тесты для проверки себя.",
                        "Блок «Разделы психологии»: сборник материалов по всем отраслям психологии.",
                        "Блок «Литература»: будущее собрание книг, учебников, пособий и т.п. для саморазвития."
                    ]
                }
            ];

            const { error: newsErr } = await supabaseClient.from('news').insert(newsToUpload);
            if (newsErr) console.error("❌ Ошибка заливки новостей:", newsErr.message);
            else console.log("✅ Все новости успешно перенесены в облако!");
        }

        // 2. Проверяем, пуст ли глоссарий в облаке
        const { data: existingGlossary } = await supabaseClient.from('glossary').select('term').limit(1);
        
        if (!existingGlossary || existingGlossary.length === 0) {
            console.log("🧠 Облачный глоссарий пуст. Начинаем пакетный импорт всех 300+ терминов из script.js...");
            
            if (typeof psychologyGlossary !== "undefined") {
                const glossaryItems = Object.keys(psychologyGlossary).map(term => {
                    // Умная привязка дисциплины на основе контента, чтобы не было хаоса
                    let discId = "general-psych";
                    if (term.toLowerCase().includes("групп") || term.toLowerCase().includes("рол") || term.toLowerCase().includes("социо")) {
                        discId = "social-psych";
                    } else if (term.toLowerCase().includes("возраст") || term.toLowerCase().includes("детств") || term.toLowerCase().includes("кризис")) {
                        discId = "developmental-psych";
                    }
                    
                    return {
                        term: term.trim(),
                        definition: psychologyGlossary[term],
                        discipline_id: discId
                    };
                });

                // Режем массив на пачки по 40 штук, чтобы шлюз пропустил данные
                const chunkSize = 40;
                for (let i = 0; i < glossaryItems.length; i += chunkSize) {
                    const chunk = glossaryItems.slice(i, i + chunkSize);
                    const { error: glossErr } = await supabaseClient.from('glossary').insert(chunk);
                    if (glossErr) console.error(`❌ Ошибка на пакете ${i}:`, glossErr.message);
                }
                console.log(`🎉 Миграция завершена! Все ${glossaryItems.length} терминов успешно скопированы в СУБД.`);
            } else {
                console.error("❌ Объект psychologyGlossary не найден в коде!");
            }
        }

    } catch (e) {
        console.error("❌ Сбой скрипта миграции:", e);
    }
}

// Запускаем автомиграцию при старте приложения
runCloudMigration();
